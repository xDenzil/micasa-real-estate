...
$_SESSION['errFlagEditPage'] == false;
    ...
    if (empty($_POST['firstname'])) {
        $_SESSION['firstname_error'] = "<span class='error small-text'>* Please enter updated first name. </span>";
        ...
        if (!preg_match("/^[a-zA-Z ]*$/", $_POST['firstname'])) {
            ...
            $_SESSION['firstname_error'] = "<span class='error small-text'>* User First name must be more than 3 characters long. </span>";
            $_SESSION['firstname'] = $_POST['firstname'];
            $_SESSION['errFlag0'] = true;
        } else {
    ...
    if (empty($_POST['lastname'])) {
        $_SESSION['lastname_error'] = "<span class='error small-text'>* Please enter updated last name. </span>";
    ...
    if (empty($_POST['email'])) {
        $_SESSION['email_error'] = "<span class='error small-text'>* Please enter valid user email address. </span>";
        $_SESSION['email'] = null;
