                                           ...
                                           echo'<table class="table table-borderless table-responsive">';
                                               ...
                                               while($row = mysqli_fetch_array( $result )) {
                                                    echo"<tr>";
                                                       ...
                                                       echo '<td><input type="submit" class="btn btn-success text-white rouund m-0" role="button" value="Edit"> <a href="edit.php?id=' . $row['Username'] . '"></a></td>';
                                                       echo '<td><input type="submit" class="btn btn-danger rouund m-0" role="button" value="Delete"><a href="delete.php?id=' . $row['Username'] . '"></a></td>';
                                                    echo "</tr>";
                                               }
                                                echo"</tbody>";
                                            echo"</table>";
