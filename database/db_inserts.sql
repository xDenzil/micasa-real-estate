...
VALUES (1,'30 Burlington Ave','Half Way Tree','Kingston','Kingston & St. Andrew',35,'Purchase','Commercial','Apartment',2,1,3500000,'testimg.jpg');
...
VALUES (1,'10 Wynter Drive','Portmore','St. Catherine',22,'Rent','Commercial','Apartment',4,4,1500000,'testimg.jpg');


INSERT INTO `mi_casa`.`property`(`userID`, `Address1`, `City`, `Parish`, `Size`, `ListingType`, `PropertyType`, `BuildingType`, `NumBedroom`, `NumBathroom`, `Price`, `PreviewImageURL`) 
VALUES (3,'9 Arthur Lane','Spanish Town','St. Catherine',56,'Lease','Residential','Housing',2,2,950000,'testimg.jpg');
